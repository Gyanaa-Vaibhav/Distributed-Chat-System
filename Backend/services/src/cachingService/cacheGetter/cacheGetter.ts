...
const client = await redisClient.getInstance('cache');
...
export const cacheGetterCache = new CacheGetter('cache');
export const cacheGetterPubSub = new CacheGetter('pub-sub');
